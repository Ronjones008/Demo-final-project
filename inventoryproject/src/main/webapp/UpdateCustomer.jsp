...
<jsp:useBean id="dao" class="com.Infinite.inventoryproject.CustomerDAO"></jsp:useBean>
	...
	<div class="align-items-center" style="width: 400px;display:flex;align-items:center;justify-content:center">
		<form action="UpdateCustomer.jsp">
			...
			<input name="address1" style="width:70%" class="form-control" type="text" value="${customers.address1}" required>
			</div>
			<div  class="mb-3 formI">
			<label style="width:27%">address2:</label>
			<input name="address2" style="width:70%" class="form-control" type="text" value="${customers.address2}"required >
			</div>
			<div  class="mb-3 formI">
			 <label style="width:27%">Pincode:</label>
			<input name="zipcode" style="width:70%" class="form-control" type="number" value="${customers.zipcode}"required >
			</div>
			<div  class="mb-3 formI">
